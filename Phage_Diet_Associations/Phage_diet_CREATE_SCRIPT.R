...
# Apply inverse normalisation to diet columns 
dat_diet <- dat_diet %>%
...
# create formula 
formula_template <- "y ~ x + gm_age + gm_sex + (1 | fid) + (1 | gm_batch)"
...
path <- file.path("/scratch/users/k2480753/phages/phage_diet", paste0("phages_diet_RESULTS_", index, ".csv"))
