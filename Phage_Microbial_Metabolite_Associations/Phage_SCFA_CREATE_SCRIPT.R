...
n_jobs <- 10 # Number of array jobs 

n_cols <- length(phage_columns) # Number of phage columns 

cols_per_job_large <- 1675  
...
path <- file.path("/scratch/users/k2480753/phages/phages_SCFA", paste0("phages_SCFA_RESULTS_", index, ".csv"))
